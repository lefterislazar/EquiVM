...
theorem RD.rawGas {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {stk : List UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
    (h : RD code ee g s0 pc stk mem aw rdata acc k C)
...
theorem RD.rawReturndatacopy {code : ByteArray} {ee : ExecutionEnv} {g : Sat256}
...
theorem RD.rawMstore {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
...
theorem RD.rawCalldatacopy {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
    {a b c : UInt256} {t : List UInt256} (mcost : ℕ)
    (memout : ByteArray) (awout : UInt256)
...
theorem RD.rawCodecopy {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
    {a b c : UInt256} {t : List UInt256} (mcost : ℕ)
    (memout : ByteArray) (awout : UInt256)
...
theorem RD.rawMload {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
...
theorem RD.rawSstore {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
...
theorem RD.rawKeccak256 {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
...
theorem RD.rawSload {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {cA : Batteries.RBSet AccountAddress compare} {σ : AccountMap} {k C : ℕ}
    {a : UInt256} {t : List UInt256}
...
theorem RD.rawLog1 {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
...
theorem RD.rawLog3 {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
...
/-- **LOG4**: pop `[offset, size, t1, t2, t3, t4]`, append a log over
    ...
    (aborts in static mode).  The `substate.logSeries` append is invisible to `RD`. -/
theorem RD.rawLog4 {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
...
theorem RD.rawRet {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
...
theorem RD.rawRev {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    {pc : UInt256} {mem : ByteArray} {aw : UInt256} {rdata : ByteArray}
    {acc : Batteries.RBSet AccountAddress compare × AccountMap} {k C : ℕ}
...
/-! `RD.pack` is the continuation boundary used by generated block summaries.  A block whose
gas is fully deterministic can retain exact counters; once it crosses an opcode such as `SLOAD`
or `SSTORE`, whose warm/cold cost depends on state deliberately hidden by `RD`, the generator
packages the counters existentially and continues stacking ordinary `RD` steps. -/
...
theorem RD.sload {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    ...
    ∃ k' C', RD code ee g s0 (pc + ⟨1⟩) (storageRead ee.codeOwner σ slot :: t)
      mem aw rdata (cA, σ) k' C' := by
  simpa only [storageRead] using RD.rawSload h hdec hov
...
theorem RD.sstore {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
  ...
  simpa only [storageWrite] using RD.rawSstore h hperm hdec hov
...
theorem RD.ret {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
  ...
  apply RD.rawRet (memExpansionCost aw off len)
...
theorem RD.rev {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
    ...
    (hov : t.length ≤ 1024) :
    RDrev code g s0 := by
  apply RD.rawRev (memExpansionCost aw off len) h hdec
  · intro s hawS hstkS
    simp [memExpansionCost, M, memoryExpansionCost, memoryExpansionCost.μᵢ', hawS, hstkS]
  · exact hov
...
theorem RD.returndatacopyOOG_error {code : ByteArray} {ee : ExecutionEnv} {g : Sat256}
    ...
    (hov : t.length ≤ 1024) :
    X (g.toNat + 1) (D_J code 0) s0 = .error .OutOfGass := by
  apply RD.rawReturndatacopyOOG_error
...
/-! `Reach` historically omitted `LOG2`; generated solc blocks use it for two-topic events. -/
...
/-- `LOG2` with deterministic active-word growth and memory cost, for generated blocks. -/
theorem RD.log2 {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
  ...
  rcases h with hoog | ⟨s, hX, hcode, hpc, hstk, hgas, hk, hC, hmem, haw, hrdata,
      hacc, hee, hworld⟩
  · exact Or.inl hoog
  · have hmcS : memoryExpansionCost s .LOG2 = memExpansionCost aw a b := by
      simp [memExpansionCost, M, memoryExpansionCost, memoryExpansionCost.μᵢ', haw, hstk]
    have hperms : s.executionEnv.perm = true := by rw [hee]; exact hperm
...
/-- Terminal summary for the explicit `INVALID` instruction. -/
...
theorem RD.invalid {code : ByteArray} {ee : ExecutionEnv} {g : Sat256} {s0 : State}
  ...
  · exact Or.inl hoog
  · right
    have st : Xstep (D_J code 0) s = .error .InvalidInstruction := by
      have hd : decode s.executionEnv.code s.machineState.pc = some (.INVALID, .none) := by
        rw [hcode, hpc]
        exact hdec
      have st0 := step_invalid s hd
      rw [hcode] at st0
      exact st0
    have hfuel : g.toNat + 1 - k = (g.toNat - k) + 1 := by omega
    rw [hX, hfuel]
...
/-- Automation-facing wrapper for `DUP12`, completing the stack-op coverage used by the block generator. -/
...
/-- Automation-facing wrapper for `DUP16`, completing the stack-op coverage used by the block generator. -/
...
/-- Automation-facing wrapper for `SWAP9`, completing the stack-op coverage used by the block generator. -/
...
/-- Automation-facing wrapper for `SWAP12`, completing the stack-op coverage used by the block generator. -/
...
/-- Automation-facing wrapper for `SWAP13`, completing the stack-op coverage used by the block generator. -/
...
/-- Automation-facing wrapper for `SWAP14`, completing the stack-op coverage used by the block generator. -/
...
/-- Automation-facing wrapper for `SWAP15`, completing the stack-op coverage used by the block generator. -/
...
/-- Automation-facing wrapper for `SWAP16`, completing the stack-op coverage used by the block generator. -/
